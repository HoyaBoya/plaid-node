...
var requestWithIncomeVerificationId =
  function(path, requestOptions = {}) {
    console.log('YOLO')
...
Client.prototype._requestWithIncomeVerificationId =
  requestWithIncomeVerificationId
...
Client.prototype.downloadDocuments =
  Client.prototype._requestWithIncomeVerificationId(
    '/income/verification/documents/download', { binary: true });
